...
# import Final_working_real_time_map_both_foot as g
...
class Ui_GATTII(object):
    ...
    def generate_report1(self):
        ...
        # a=ab.demo()
        # a.setupUi()
        second.setup(self.name,self.age1,self.date1,self.foot_lengtht_left1,self.foot_lenght_right1,self.foot_width_left1,self.foot_width_right1,self.weight1,self.walk_lenght1,self.gender_female,self.gender_male)
...
class second:
    file1_name=""
    def setup(name,age1,date1,foot_lengtht_left1,foot_lenght_right1,foot_width_left1,foot_width_right1,weight1,walk_lenght1,gender_female,gender_male):
        name=name
        age=age1
        date=date1
        foot_length_left=foot_lengtht_left1
        foot_lenght_right=foot_lenght_right1
        foot_width_left=foot_width_left1
        foot_width_right=foot_width_right1
        weight=weight1
        walk_lenght=walk_lenght1
    ...
    # ui.setupUi(Dialog)
        ...
        label.setGeometry(QtCore.QRect(10, 20, 180, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        label.setFont(font)
        ...
        """)
        left_leg.setGeometry(QtCore.QRect(180, 20, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        left_file_name.setGeometry(QtCore.QRect(160, 150, 241, 31))
        ...
        label.setText(_translate("Form", "Select File For Report:"))
        ...
        def result2():
            ...
            dr.data_read(f1,name,age,date,foot_length_left,foot_lenght_right,foot_width_left,foot_width_right,weight,walk_lenght,female,male)
